...
<div class="uk-grid uk-margin-bottom">
    <div class="uk-width-1-1">
        <button class="uk-button uk-button-primary" onClick=add_function(); type="button">Tambah User</button>
...
<script type="text/javascript" language="javascript" >
    ...
    $(document).ready(function() {
        dataTable = $('#<?php echo $panel_title; ?>-grid').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                url :"<?php echo base_url("auth/ajax_grid"); ?>", // json datasource
    ...
    function del_function(m,id) {
        ...
        {
            var base_url = "auth/delete_data?m="+m+"&id="+id;
            window.location.href = "<?php echo base_url(); ?>"+base_url;
        }
        else
        {}
