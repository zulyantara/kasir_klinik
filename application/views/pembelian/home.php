...
<div class="uk-grid uk-margin-bottom">
    <div class="uk-width-1-1">
        <button class="uk-button uk-button-primary" onClick=add_function(); type="button">Pembelian Obat</button>
...
<script type="text/javascript" language="javascript" >
    ...
    function add_function() {
        var base_url = "<?php echo $panel_title; ?>/form_head";
        window.location.href = "<?php echo base_url(); ?>"+base_url;
    }

    // function edit_function(m,id) {
    // 	var base_url = "<?php echo $panel_title; ?>/form_edit?m="+m+"&id="+id;
    // 	window.location.href = "<?php echo base_url(); ?>"+base_url;
    // }
