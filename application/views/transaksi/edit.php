<?php
$random = rand();
$rand_tk = base64_encode($random."-".$k."-".$c."-".$p."-".$ka);
?>
<div class="uk-grid">
    ...
    <div class="uk-width-2-3">
        ...
        <form class="uk-form uk-form-horizontal" method="post" action="<?php echo base_url("transaksi/form_detail?k=".$rand_tk); ?>">
            ...
            <div class="uk-form-row">
                <label class="uk-form-label" for="">Nama Barang</label>
                <div class="uk-form-controls">
                    <input type="hidden" name="opt_barang" id="opt_barang" value="0">
                    <input type="text" name="txt_barang" id="txt_barang" placeholder="Nama Barang">
                </div>
            </div>
            <div class="uk-form-row">
