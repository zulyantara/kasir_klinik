...
<div class="uk-grid uk-margin-bottom">
    <div class="uk-width-1-1">
        <button class="uk-button uk-button-primary" onClick=add_function(); type="button">Tambah Kode Akun</button>
...
<table id="<?php echo $panel_title; ?>-grid" class="uk-table uk-table-hover uk-table-striped uk-table-condensed">
    <thead>
        <tr>
            ...
            <th>Keterangan</th>
            <th style="width: 15%">Jenis Akun</th>
            <th>Option</th>
        </tr>
    </thead>
    <tfoot>
        ...
        dataTable = $('#<?php echo $panel_title; ?>-grid').DataTable( {
            ...
            "ajax":{
                ...
                error: function(){  // error handling
                    $("#<?php echo $panel_title; ?>-grid").append('<tbody class="<?php echo $panel_title; ?>-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
