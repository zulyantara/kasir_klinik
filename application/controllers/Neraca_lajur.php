...
class Jurnal extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model("neraca_lajur_model", "nlm");
    }
    ...
    function cetak()
    {
        ...
        $data["qry_jurnal"] = $this->nlm->get_data_jurnal($data);
        // $data["qry_transaksi"] = $this->nlm->get_data_transaksi($data);
        // $data["qry_pengeluaran"] = $this->nlm->get_data_pengeluaran($data);
        // $data["qry_payroll"] = $this->nlm->get_data_payroll($data);
